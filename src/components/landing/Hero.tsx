  ...
  return (
    <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, var(--chart-4) 0%, transparent 70%)", animationDelay: "-5s" }}
      />
      <div
        ...
        style={{ background: "radial-gradient(circle, var(--chart-2) 0%, transparent 70%)" }}
      />
    ...
    <section className="relative overflow-hidden pt-32 pb-24 md:pt-44 md:pb-32">
      ...
      <div className="mx-auto max-w-5xl px-6 text-center">
        ...
        <Typography
          ...
          style={{ fontSize: "clamp(2.5rem, 6vw, 4.5rem)", lineHeight: 1.05, letterSpacing: "-0.035em" }}
        >
          {cfg.headlineStatic}
          <br />
        ...
        <div className="animate-text-reveal delay-500 mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Button
            ...
            style={{ boxShadow: "0 0 30px color-mix(in srgb, var(--primary) 25%, transparent)" }}
        ...
        <div className="animate-text-reveal delay-800 relative mx-auto mt-20 max-w-4xl">
          ...
          <div className="absolute -inset-4 rounded-2xl opacity-50 blur-2xl animate-glow-pulse" style={{ background: "linear-gradient(to right, color-mix(in srgb, var(--primary) 10%, transparent), color-mix(in srgb, var(--chart-4) 10%, transparent))" }} />

          {/* Orbit rings — decorative */}
          <div className="absolute -inset-8 rounded-2xl border border-primary/5 animate-orbit-reverse" style={{ borderRadius: "24px" }} />
          ...
          <div className="relative overflow-hidden rounded-2xl border border-border/50 bg-card/80 backdrop-blur-xl shadow-2xl shadow-primary/5">
            ...
            <div className="relative">
              ...
              <div className="absolute top-4 right-4 flex flex-col gap-2">
                {(["Custom Background", "Trim & Export", "1080p"] as const).map((label, i) => (
                  <div
                    key={label}

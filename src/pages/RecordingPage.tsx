          ...
          {recordingState === "recording" && (
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="w-full aspect-video bg-destructive/5 border border-destructive/20 flex flex-col items-center justify-center gap-4">
                ...
                <div className="text-center">
                  <Typography variant="body-sm" className="text-destructive font-medium">
                    Recording in progress
                  </Typography>
                  <Typography variant="code" as="p" className="text-foreground mt-1 tabular-nums text-3xl">
              ...
              >
                ...
                <Typography variant="label" as="span">Stop Recording</Typography>
              </button>
            </div>
          )}
        </div>
